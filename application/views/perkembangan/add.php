					...
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								...
								<?php endif ?>
								<form action="<?= base_url('roles/add') ?>" id="form-add" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="name"><strong>Role Name</strong></label>
											<input type="text" name="name" placeholder="Enter your role name" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<hr>
